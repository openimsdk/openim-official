        ...
        <ul className="relative pb-12">
          <li className="max-w-3xl">
            ...
            <p className="text-sm sm:text-base">
              我们致力于通过开源模式，为全球企业/开发者提供简单、易用、高效的M服务和实时音视频通讯能力，帮助开发者降低项目的开发成本，
              并让开发者掌控业务的核心数据。
            </p>
          </li>
          <li className="max-w-3xl py-8">
            ...
            <p className="text-sm sm:text-base">
              ...
              对数据资产的价值、数据安全的重要性有了更清晰的认识，数据安全成就企业核心价值。M作为核心
          ...
          <li className="max-w-3xl">
            ...
            <p className="text-sm sm:text-base">
              创始团队来自资深M技术团队，我们致力于用开源技术创造服务价值，打造轻量级、高可用的M架构，
              开发者只需简单调用SDK,即可在应用内构建多种即时通讯及实时音视频互动场景。OpenIM邀请全球
              技术极客参与技术优化，让开发者轻松集成，让每一个应用都具备M功能，同时考虑企业的接入成本、
